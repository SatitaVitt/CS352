            ...
            with open(table, 'r') as DNSfile:
                for line in DNSfile:
                    ...
                    if len(breakIntoArray) < 3:
                        print("it is NULL")
                        continue
                    print("breakintoarray RS:", breakIntoArray)
                    ...
                    if breakIntoArray[0] == hostNameStr:
                        sendBackMsg = line
                        print("[RS]: from RS directly -> ", sendBackMsg)
